...
def main(config):
    ...
    flatten_model_name = str(config.actor_rollout_ref.model).replace("/", "-")
    save_path = f"nl_traj_collect/{config.trainer.experiment_name}_all_trajs_{config.env.env_name}_{flatten_model_name}.jsonl"
